...
public class ChosenCourseItem {
    ...
    private List<ChosenCourseDetail> ccd;

    public ChosenCourseItem() {
    }
    ...
    public List<ChosenCourseDetail> getCcd() {
        return ccd;
    }

    public void setCcd(List<ChosenCourseDetail> ccd) {
        this.ccd = ccd;
    }

    @Override
    public String toString() {
        return "ChosenCourseItem{" +
                "id=" + sele_id +
                ", st_id=" + st_id +
                ", semester='" + semester + '\'' +
                ", year=" + year +
